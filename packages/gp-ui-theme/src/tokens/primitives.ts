/**
 * Default Primitive Tokens for gp-ui
 * Includes complete color palettes, typography scales, spacing, radius, shadows, and transitions.
 */
import { GpPrimitives } from './types';
...
export const defaultPrimitives: GpPrimitives = {
