...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, GpButton, GpDrawer, GpInputNumber, GpInputText],
  templateUrl: './overlay-slide-over-panel.html',
  styleUrl: './overlay-slide-over-panel.scss'
})
export class GpOverlaySlideOverPanel {
