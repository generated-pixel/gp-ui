...
import { GpButton, GpRating } from '@generatedpixel/gp-ui';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, GpButton, GpRating],
  templateUrl: './feedback-rating-review.html',
  styleUrl: './feedback-rating-review.scss'
})
export class GpFeedbackRatingReview {
