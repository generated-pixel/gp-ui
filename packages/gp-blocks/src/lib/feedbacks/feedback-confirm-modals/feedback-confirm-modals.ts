...
import { GpButton, GpIcon, GpButtonSeverity } from '@generatedpixel/gp-ui';
...
@Component({
  ...
  templateUrl: './feedback-confirm-modals.html',
  styleUrl: './feedback-confirm-modals.scss'
})
export class GpFeedbackConfirmModals {
