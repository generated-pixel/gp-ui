...
import { GpProgressBar } from '@generatedpixel/gp-ui';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, GpProgressBar],
  templateUrl: './data-display-meter-metrics.html',
  styleUrl: './data-display-meter-metrics.scss'
})
export class GpDataDisplayMeterMetrics {
