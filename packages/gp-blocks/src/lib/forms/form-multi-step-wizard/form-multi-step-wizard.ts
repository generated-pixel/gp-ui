...
import { GpButton, GpCheckbox, GpIcon, GpInputText } from '@generatedpixel/gp-ui';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, GpButton, GpCheckbox, GpIcon, GpInputText],
  templateUrl: './form-multi-step-wizard.html',
  styleUrl: './form-multi-step-wizard.scss'
})
export class GpFormMultiStepWizard {
