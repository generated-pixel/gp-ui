...
import { GpButton, GpInputText, GpTextarea } from '@generatedpixel/gp-ui';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, GpButton, GpInputText, GpTextarea],
  templateUrl: './form-user-profile.html',
  styleUrl: './form-user-profile.scss'
})
export class GpFormUserProfile {
