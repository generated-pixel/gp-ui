...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, GpButton, GpIcon, GpInputText, GpSelect],
  templateUrl: './form-advanced-filter-builder.html',
  styleUrl: './form-advanced-filter-builder.scss'
})
export class GpFormAdvancedFilterBuilder {
