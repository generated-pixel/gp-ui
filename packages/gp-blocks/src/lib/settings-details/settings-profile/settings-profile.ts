...
import { GpAvatar, GpButton, GpInputText, GpTextarea } from '@generatedpixel/gp-ui';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, GpAvatar, GpButton, GpInputText, GpTextarea],
  templateUrl: './settings-profile.html',
  styleUrl: './settings-profile.scss'
})
export class GpSettingsProfile {
