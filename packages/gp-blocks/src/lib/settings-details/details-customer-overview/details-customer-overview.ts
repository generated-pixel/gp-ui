...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, GpAvatar, GpBadge, GpButton],
  templateUrl: './details-customer-overview.html',
  styleUrl: './details-customer-overview.scss'
})
export class GpDetailsCustomerOverview {
