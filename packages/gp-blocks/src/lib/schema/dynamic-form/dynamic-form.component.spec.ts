...
import { GpDynamicFormComponent } from './dynamic-form.component';
import { GpFormSchema } from '../schema.types';

describe('GpDynamicFormComponent', () => {
  let component: GpDynamicFormComponent;
  let fixture: ComponentFixture<GpDynamicFormComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(GpDynamicFormComponent);
