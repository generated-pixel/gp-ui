...
import { GpIcon, GpInputText } from '@generatedpixel/gp-ui';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, GpIcon, GpInputText],
  templateUrl: './sidebar-search-tree.html',
  styleUrl: './sidebar-search-tree.scss'
})
export class GpLayoutSidebarSearchTree {
