...
import { GpIcon, GpAvatar, GpButton } from '@generatedpixel/gp-ui';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, GpIcon, GpAvatar, GpButton],
  templateUrl: './stacked-subnav-tabs.html',
  styleUrl: './stacked-subnav-tabs.scss'
})
export class GpLayoutStackedSubnavTabs {
