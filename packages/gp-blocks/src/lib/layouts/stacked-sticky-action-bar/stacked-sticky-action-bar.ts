...
import { GpButton, GpIcon, GpBadge, GpInputText } from '@generatedpixel/gp-ui';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, GpButton, GpIcon, GpBadge, GpInputText],
  templateUrl: './stacked-sticky-action-bar.html',
  styleUrl: './stacked-sticky-action-bar.scss'
})
export class GpLayoutStackedStickyActionBar {
