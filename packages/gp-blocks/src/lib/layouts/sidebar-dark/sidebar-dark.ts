...
import { GpAvatar, GpIcon, GpBadge, GpBadgeSeverity } from '@generatedpixel/gp-ui';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, GpAvatar, GpIcon, GpBadge],
  templateUrl: './sidebar-dark.html',
  styleUrl: './sidebar-dark.scss'
})
export class GpLayoutSidebarDark {
