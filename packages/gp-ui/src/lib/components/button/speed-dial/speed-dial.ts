...
import { GpMenuItem } from '../split-button/split-button';
import { GpButtonBase, GpButtonSeverity, GpButtonVariant } from '../../../base/gp-button-base';
...
@Component({
  ...
  standalone: true,
  imports: [GpButton, GpTooltipDirective],
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  templateUrl: './speed-dial.html',
  styleUrl: './speed-dial.scss'
})
export class GpSpeedDial extends GpButtonBase {
