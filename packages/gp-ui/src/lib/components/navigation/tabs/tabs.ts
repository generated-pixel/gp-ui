...
import { GpBadge, GpBadgeSeverity } from '../../feedback/badge/badge';
...
@Component({
  selector: 'gp-tabs',
  standalone: true,
  imports: [GpBadge, GpIcon],
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  templateUrl: './tabs.html',
  styleUrl: './tabs.scss'
})
export class GpTabs extends GpBase {
  public tabPanels = contentChildren(GpTabPanel);
  ...
  public selectTab(tab: GpTabPanel): void {
    if (tab.disabled()) {
      return;
    }
    const panels = this.tabPanels();
  ...
  public closeTab(tab: GpTabPanel, event: MouseEvent): void {
