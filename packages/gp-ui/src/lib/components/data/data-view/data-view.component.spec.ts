import { GpDataViewComponent } from './data-view.component';
import { GpPaginatorComponent } from '../paginator/paginator.component';

describe('GpDataViewComponent & GpPaginatorComponent', () => {
  describe('GpDataViewComponent', () => {
    let component: GpDataViewComponent;
    const testItems = [
      { id: 1, name: 'Item 1' },
      { id: 2, name: 'Item 2' },
      { id: 3, name: 'Item 3' },
    ...
    beforeEach(() => {
      component = new GpDataViewComponent();
  ...
  describe('GpPaginatorComponent', () => {
    let paginator: GpPaginatorComponent;

    beforeEach(() => {
      paginator = new GpPaginatorComponent();
