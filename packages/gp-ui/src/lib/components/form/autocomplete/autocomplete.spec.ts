...
import { GpAutoComplete } from './autocomplete';
import { Subject } from 'rxjs';

describe('GpAutoComplete', () => {
  let component: GpAutoComplete;
  let fixture: ComponentFixture<GpAutoComplete>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [GpAutoComplete]
    }).compileComponents();

    fixture = TestBed.createComponent(GpAutoComplete);
