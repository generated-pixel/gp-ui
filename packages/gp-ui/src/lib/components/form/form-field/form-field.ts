...
import { GpLabel } from '../label/label';
import { GpIcon } from '../../../icons/icon';

@Component({
  selector: 'gp-form-field',
  standalone: true,
  imports: [GpLabel, GpIcon],
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  templateUrl: './form-field.html',
  styleUrl: './form-field.scss'
})
export class GpFormField extends GpBase {
  ...
  public labelComponent = contentChild(GpLabel);
  ...
  override onAfterContentInit(): void {
