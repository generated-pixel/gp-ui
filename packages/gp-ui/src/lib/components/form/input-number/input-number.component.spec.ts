...
import { GpInputNumberComponent } from './input-number.component';

describe('GpInputNumberComponent', () => {
  let component: GpInputNumberComponent;
  let fixture: ComponentFixture<GpInputNumberComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [GpInputNumberComponent]
    }).compileComponents();

    fixture = TestBed.createComponent(GpInputNumberComponent);
