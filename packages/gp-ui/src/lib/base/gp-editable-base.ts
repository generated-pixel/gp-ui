import { Directive, input, output, signal, computed, inject, ElementRef } from '@angular/core';
 ...
 * Inherits core identity and styling from GpBase, adding value state management,
...
/**
 * Backward-compatible alias for GpEditableBase
 */
export { GpEditableBase as GpBaseControlValueAccessor };
