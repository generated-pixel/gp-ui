...
/**
 * Baseline immutable English (en-US) dictionary.
 * Serves as the fallback default for every other language and regional dialect.
 */
export const ENGLISH_US_TRANSLATIONS: Record<TranslationKey, string> = {
