...
import { GpBase, GpIcon, GpEmptyState, GpTranslationService, GpBadgeSeverity } from '@generatedpixel/gp-ui';
import { GpGridWidget } from '../gp-grid-widget/grid-widget';
import { GpGridKpiWidget } from '../gp-grid-kpi-widget/grid-kpi-widget';
import { GpGridChartWidget } from '../gp-grid-chart-widget/grid-chart-widget';
import { GpGridTableWidget } from '../gp-grid-table-widget/grid-table-widget';
import { GpGridListWidget } from '../gp-grid-list-widget/grid-list-widget';
import { GpGridProgressWidget } from '../gp-grid-progress-widget/grid-progress-widget';
