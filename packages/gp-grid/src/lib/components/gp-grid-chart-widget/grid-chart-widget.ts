...
import { GpBadge, GpBadgeSeverity, GpIcon, GpSkeleton } from '@generatedpixel/gp-ui';
...
@Component({
  ...
  standalone: true,
  imports: [GpBadge, GpIcon, GpSkeleton],
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  templateUrl: './grid-chart-widget.html',
  styleUrl: './grid-chart-widget.scss',
  host: {
    class: 'gp-grid-chart-widget-host'
  }
})
export class GpGridChartWidget extends GpGridWidgetBase<GpChartWidgetData> {
