...
@Component({
  ...
  standalone: true,
  imports: [GpAvatar, GpBadge, GpButton, GpIcon, GpSkeleton],
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  templateUrl: './grid-table-widget.html',
  styleUrl: './grid-table-widget.scss',
  host: {
    class: 'gp-grid-table-widget-host'
  }
})
export class GpGridTableWidget extends GpGridWidgetBase<GpTableWidgetData> {
