...
import { GpProgressBar, GpIcon, GpSkeleton } from '@generatedpixel/gp-ui';
...
@Component({
  ...
  standalone: true,
  imports: [GpProgressBar, GpIcon, GpSkeleton],
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  templateUrl: './grid-progress-widget.html',
  styleUrl: './grid-progress-widget.scss',
  host: {
    class: 'gp-grid-progress-widget-host'
  }
})
export class GpGridProgressWidget extends GpGridWidgetBase<GpProgressWidgetData> {
