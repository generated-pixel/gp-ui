...
- [`gp-analytics`](packages/gp-analytics/README.md): Analytics models, datasets, reports, and dashboards. Build with `npm run build:analytics` and test with `npm run test:analytics`.
