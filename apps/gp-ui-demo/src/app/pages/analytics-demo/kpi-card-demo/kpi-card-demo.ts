...
/>`;
  ...
  protected readonly properties: DocApiProperty[] = [
    { name: 'widgetId', type: 'input<string>', default: "''", description: 'Identifier passed back on refresh/export/configure events.' },
    ...
    { name: 'description', type: 'input<string>', default: "''", description: 'Optional longer description shown in tooltip/expanded views.' },
    { name: 'error', type: 'input<string | null>', default: 'null', description: 'Error message; when set, the card renders an error state.' },
    { name: 'value', type: 'input<number | string>', default: '0', description: 'The raw metric value.' },
    { name: 'formattedValue', type: 'input<string | null>', default: 'null', description: 'Pre-formatted value string; overrides automatic formatting.' },
    { name: 'currency', type: 'input<string | null>', default: 'null', description: 'ISO currency code used to format the value as currency.' },
    { name: 'previousValue', type: 'input<number | null>', default: 'null', description: 'Previous period value, used to compute variance.' },
    { name: 'variancePercentage', type: 'input<number | null>', default: 'null', description: 'Percentage change vs. the previous value.' },
    { name: 'trend', type: "input<'up'|'down'|'neutral'>", default: "'neutral'", description: 'Directional trend indicator.' },
    { name: 'severity', type: "input<'success'|'danger'|'info'|'warning'>", default: "'info'", description: 'Visual severity/accent color.' },
    { name: 'targetValue', type: 'input<number | null>', default: 'null', description: 'Target value used to compute progress.' },
    { name: 'targetProgress', type: 'input<number | null>', default: 'null', description: 'Explicit progress percentage toward the target (0-100).' },
    { name: 'sparklinePoints', type: 'input<number[]>', default: '[]', description: 'Historical data points rendered as an inline sparkline.' },
    ...
    { name: 'alertThreshold', type: 'input<number | null>', default: 'null', description: 'Threshold used to trigger the alert state.' },
    { name: 'alertCondition', type: "input<'above'|'below'>", default: "'below'", description: 'Whether the alert triggers above or below the threshold.' },
    { name: 'alertMessage', type: 'input<string | null>', default: 'null', description: 'Message shown when the alert condition is met.' }
  ];
